...
$campos_cabecera_csv_sol=array('Centro','Primer apellido','Segundo apellido','Nombre','Enseñanza','Centro de procedencia','Transporte','Localidad domicilio familiar');
$campos_bbdd_csv_sol=array('nombre_centro','apellido1','apellido2','nombre','tipoestudios','nombre_centro_origen','transporte','loc_dfamiliar');
